...
- **Playlist editing** — `playlist_edit_screen.dart` and `AddToPlaylistScreen/` still call Jellyfin for playlist create/edit/delete. This and the `network_settings_screen.dart` ping are the only remaining Phase 5 items.
